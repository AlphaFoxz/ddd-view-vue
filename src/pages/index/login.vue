<template>
  <view>
    ...
    <div class="logopng">
      <p>CopyRight 2022 EricFox@Gitee.com</p>
    </div>

    <div class="container" style="position:relative; top:28%">
        ...
        <div class="tublder">
          ...
          <form action="index.html" method="post">
            ...
            <div class="panel loginbox">
              ...
              <span class="tuoper1"></span>
              <span class="tuoper2"></span>
              <span class="tuoper3"></span>
              <span class="tuoper4"></span>
              <div class="fl" style="margin:2px 0 0 16px;">
                <img src="/static/images/tmbg-white1.png">
              </div>
              <div class="fr" style="width:355px;">
                <div class="text-center margin-big padding-big-top">
                  <h1>用户登录</h1>
                </div>
                <div class="panel-body" style="padding:0 25px 0 5px;">
                  <div class="form-group">
                    <div class="field field-icon-right">
                      <input type="text" class="input input-big" name="name" id="username" placeholder="登录账号"/>
                      <span class="tubieder"></span>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="field field-icon-right">
                  ...
                  <div class="form-group">
                    <input name="" type="checkbox" value="" class="fl" style="margin-top:2px;">&nbsp;&nbsp;<span
                      class="fl" style="padding-left:6px; color:#fff; font-size:12px;">记住密码</span>
                  </div>
                  <div style=" width:325px; border-radius:6px; overflow:hidden" class="input_button_1">
                    <input type="button" id="button" class="" value="登&nbsp;录" style="width:325px; font-size:16px;">
                  </div>
                </div>
              </div>
            </div>
...
<style scoped>
  ...
  *:before,*:after{-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;}
  ...
  .logopng1{ position:absolute; left:15px; top:15px; z-index:999}
  ...
  .margin-big-bottom {width:404px; margin:0 auto; position:relative; z-index:999}
  .margin-big-bottom span{ display:block; line-height:31px; font-size:22px; color:#fff; padding-left:40px; background:url(/static/images/logo.png) no-repeat}
  .input{font-size:14px;padding:10px; border:solid 1px #0a5f8e; background:none; width:100%;line-height:20px;display:block; }
  ...
  input,select,textarea{color:#fff; font-weight:100}
  .bg{ width:100%; height:100%; position:absolute; background:url(/static/images/bg.jpg) }
  .panel{background:#fff;}
  form .form-group:last-child{padding-bottom:0;}
  .passcode{position:absolute;right:0;bottom:0;height:32px;border-left:solid 1px #ddd;text-align:center;line-height:32px;}
  ul,li{ list-style-type:none;}
  .logopng{ width:100%; position:fixed; left:
      0px; text-align:center; z-index:999; color:#fff;height:30px; line-height:30px; background:#0c1020; bottom:0px;}
  .field-icon-right .icon{ bottom:0px; top:auto}
  .loginbox{ background:rgba(40,57,114,0.7); width:614px; border-radius:20px; padding:20px 0; height:350px; margin:0 auto; position:relative; z-index:9999}
  .container{ position:relative;}
  span.tuoper1{width:49px; height:47px; background:url(/static/images/icon52.png) no-repeat; position:absolute; left:-1px; top:-1px;}
  span.tuoper2{width:49px; height:47px; background:url(/static/images/icon51.png) no-repeat; position:absolute; right:-1px; top:-1px;}
  span.tuoper3{width:49px; height:47px; background:url(/static/images/icon50.png) no-repeat; position:absolute; right:-1px; bottom:-1px;}
  span.tuoper4{width:49px; height:47px; background:url(/static/images/icon49.png) no-repeat; position:absolute; left:-1px; bottom:-1px;}
  .margin-big h1{ text-align:left; line-height:40px; color:#fff; padding:15px 0 10px 5px; font-size:16px;}
  .input_button_1 input{ width:294px; height:46px; line-height:38px; background:url(../images/puder.png) no-repeat; color:#fff; border:0px;}
  .fl{ float:left}
  .fr{ float:right}
  .clear{ clear:both}
  .tublder_re{ width:328px; height:390px; margin:-50px 0 0 10%; position:relative; z-index:9999}
  html,body{
    width:100%;
    height:100%;
    background:#171e36;
